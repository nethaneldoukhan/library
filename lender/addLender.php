...
class AddLender extends Lender {
    ...
    public function sendData($conn) {
        $this->query = "INSERT INTO lenders (lastname, firstname, adress, zipcode, city, country, tel, email) VALUES ('$this->lastname', '$this->firstname', '$this->adress', '$this->zipcode', '$this->city', '$this->country', '$this->tel', '$this->email')";
        $checkExist = "SELECT * FROM lenders WHERE lastname='$this->lastname' AND firstname='$this->firstname' AND adress='$this->adress' AND zipcode='$this->zipcode' AND city='$this->city' AND country='$this->country' AND tel='$this->tel' AND email='$this->email'";
